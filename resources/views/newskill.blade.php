...
<div class="row h-25 justify-content-center">
    ...
    <table>
            ...
            <tbody>
        <tr><td><textarea id="massel" style="width: 250px; height: 250px;"
            placeholder="Paste Skills Here. Must be in correct form.    Press [alt] + [0][9] to insert tab if needed. List must be consistent"></textarea></td></tr>
            <tr><td><button id="masselbutt" onclick="massel('skillselect')">Select</button></td></tr>
        </tbody>
        </table>
            <table>
            ...
            <tr>
                ...
                <td class="top">
                    <select id="skillselect" class="selectpicker" multiple data-live-search="true" data-actions-box="true" onchange="$('#subbutt').prop('disabled',false),changed('skillselect')">
